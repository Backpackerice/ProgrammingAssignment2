## makeCacheMatrix can create a special matrix object, and then 
## cacheSolve can calculate the inverse of the matrix.
## If the matrix inverse has already been calculated, 
## it will find it in the cache and return it, 
## it and not calculate it again.
...
## a matrix A created with the makeCacheMatrix function.
